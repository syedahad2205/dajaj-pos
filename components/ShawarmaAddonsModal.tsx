...
export default function ShawarmaAddonsModal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
      <div className="flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-lg border bg-white mx-4" style={{ borderColor: SOFT_GRAY }}>
        <div className="flex justify-between items-center border-b p-6" style={{ borderColor: SOFT_GRAY }}>
        ...
        <div className="flex space-x-3 border-t p-6" style={{ borderColor: SOFT_GRAY }}>
          <button
            onClick={onClose}
